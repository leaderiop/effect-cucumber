...
- **LINT-01 — a lint rule enforcing [ADR-EC-009](decisions/009-cross-step-state-lives-in-a-ref.md)
  ...
  and it is deferred to a later milestone (`.planning/REQUIREMENTS.md` § v2).
