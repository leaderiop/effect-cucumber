...
| `gherkinWatchTriggers` / `GherkinWatchTriggersOptions`                                                                                                                        | function  | [BEH-EC-022](./behaviors/10-watch-mode.md#beh-ec-022-gherkinwatchtriggers-reruns-the-matched-testinclude-set-whenever-a-tracked-feature-file-changes)                                                                                                                                                                                                                                     |
| `FeatureDsl` / `RuleDsl` / `ScenarioDsl` / `BackgroundDsl` / `StepRegistrar` / `StepParams` / `HookRegistrar` / `TaggedHookRegistrar` / `RuleRegistrar` / `ScenarioRegistrar` | types     | [BEH-EC-003](./behaviors/01-steps-and-world.md#beh-ec-003-a-step-is-an-effect-returning-function), [BEH-EC-006](./behaviors/02-shared-layers-and-tags.md#beh-ec-006-hooks-are-effects-and-after-always-runs), [BEH-EC-027](./behaviors/07-hook-ordering-and-guarantees.md#beh-ec-027-tag-expression-scoped-hooks-compose-with-rulefeature-scoping-and-are-excluded-before-batch-assembly) |
...
| `StaleRerunManifestKeyWarning` / `StaleRerunManifestKeyWarningReason`                                                                                                         | types     | [BEH-EC-030](./behaviors/17-rerun-failed-only.md)                                                                                                                                                                                                                                                                                                                                         |
...
| `decodeExamplesRow` / `ExamplesRow` / `ExamplesRowError` / `ExamplesRowErrorReason`                                                                                           | re-export | [BEH-EC-024](./behaviors/12-outline-typed-example-column.md)                                                                                                                                                                                                                                                                                                                              |
...
| `Before` / `After` / `BeforeStep` / `AfterStep` | Feature, Rule                                      | [BEH-EC-006](./behaviors/02-shared-layers-and-tags.md#beh-ec-006-hooks-are-effects-and-after-always-runs), [BEH-EC-027](./behaviors/07-hook-ordering-and-guarantees.md#beh-ec-027-tag-expression-scoped-hooks-compose-with-rulefeature-scoping-and-are-excluded-before-batch-assembly) |
