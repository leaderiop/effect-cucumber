...
/**
 * A name-less, UNSHUFFLED block (F-24). vitest's full test name skips a suite whose name is empty, so
 * every `currentTestName()` recorded inside reads exactly as it did at file level, while
